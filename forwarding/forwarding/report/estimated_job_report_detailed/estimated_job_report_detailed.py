...
def add_total(data):
	...
	total_row.update({
				...
				"rate":final_totals.get('rate',default=0.0),
				"paid_amount":final_totals.get('paid_amount',default=0.0),
				'pending_amount': final_totals.get('pending_amount',default=0.0),
				'received_amount': final_totals.get('received_amount',default=0.0),
				'pending_amount_to_receive': final_totals.get('pending_amount_to_receive',default=0.0),
				})

...
def add_total(data):
	...
	total_row.update({
				...
				"cost":final_totals['cost'],
				"rate":final_totals['rate'],
				"paid_amount":final_totals['paid_amount'],
				'pending_amount': final_totals['pending_amount'],
				'received_amount': final_totals['received_amount'],
				'pending_amount_to_receive': final_totals['pending_amount_to_receive'],
				})
